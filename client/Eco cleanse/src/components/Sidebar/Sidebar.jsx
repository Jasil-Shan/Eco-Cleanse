...
const Sidebar = () => {
    ...
    return (
        <div className=" p-3 w-60 h-screen shadow-lg bg-white text-black">
                ...
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                    {
                        adminSidebarData.map((obj, index) => {
                            ...
                            return (
                                <li className="bg-white shadow-md font-semibold dark:text-gray-700 mt-6">
                                    {
                                        obj.links.map((link, index) => {
                                            return (
                                                <>
                                                    <a onClick={() => { navigate(link.route) }}
