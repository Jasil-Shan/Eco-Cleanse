                                    ...
                                    {users.map((item, index) => {
                                        return <tr key={index}>
                                            ...
                                            <td>
                                                {
                                                    item.blocked ?
                                                        <button onClick={() => unBlockUser(item)} type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-4 py-2 mt-2 text-center mr-2 mb-2">
                                                            Unblock</button>
                                                        :
                                                        <button onClick={() => blockUser(item)} type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 ml-3 mt-2 mb-2">
                                                            Block</button>
                                                }
                                            </td>
                                        </tr>
