                    ...
                    <div className="md:w-1/2 px-14">
                        ...
                        <form onSubmit={formik.handleSubmit} className='flex flex-col gap-4'>
                            ...
                            {loading ? (
                                ...
                                <button className='bg-[#002D74] rounded-xl font-semibold py-2 mt-2 text-white' type="submit">Log in</button>
                        ...
                        <button onClick={login} className='hover:scale-105 duration-300 bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm font-semibold'>
