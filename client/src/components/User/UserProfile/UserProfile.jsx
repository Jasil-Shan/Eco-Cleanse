...
const UserProfile = () => {
  ...
  return (
    <>
      ...
      {
        !editMode ?
          <main className="profile-page  flex justify-center items-center mt-52">
            ...
            <section className="relative py-16 bg-blueGray-200">
              <div className="container mx-auto px-4">
                <div className="relative card p-16  flex flex-col min-w-0 break-words bg-white w-full shadow-xl rounded-lg -mt-64">
                  <div className="px-6">
