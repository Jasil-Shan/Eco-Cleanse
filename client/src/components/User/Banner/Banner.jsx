      ...
      <div className="video-content space-y-2">
        <div className="mx-auto max-w-xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link to={'/booking'}>
              <h1
                className="block w-full rounded-xl bg-red-600 px-12 opacity-80 py-3 text-sm font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
              >
                Get Started
              </h1>
            </Link>
