                ...
                <div className="md:w-1/2 px-16">
                    ...
                    <form onSubmit={formik.handleSubmit} className='flex flex-col gap-6'>
                        ...
                        <div className="relative">
                            ...
                            <button type='button' onClick={handleTogglePassword}> {!showPassword ? <AiFillEye className="w-5 absolute top-1 right-3 translate-y-1/2 h-4" />
                                : <AiFillEyeInvisible className="w-5 absolute top-1 right-3 translate-y-1/2 h-4" />} </button>
                        </div>
