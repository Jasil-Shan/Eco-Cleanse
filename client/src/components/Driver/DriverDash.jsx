      ...
      <div className="md:flex no-wrap md:-mx-2 ">
        ...
        <div className="w-full md:w-3/12 md:mx-2">
          ...
          <div className="bg-base-100 shadow-md card p-3 border-t-4 border-green-400">
            ...
            <h1 className="text-gray-900 font-bold text-xl leading-8 my-1">{driver.name}</h1>
            <h3 className="text-gray-600 font-lg text-semibold leading-6 uppercase">{driver.role}</h3>
            ...
            <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
              <li className="flex items-center py-3">
                ...
                <span className="ml-auto">
                  <span className="bg-green-500 py-1 px-2 rounded text-white text-sm">{driver.status}</span>
                </span>
              </li>
              <li className="flex items-center py-3">
          ...
          <div className="bg-white p-3 shadow-sm rounded-sm">
            <div className="grid grid-cols-2">
              ...
              <div>
                ...
                <ul className="list-inside space-y-2">
                  <li>
                    <div className="text-teal-600">Masters in Software Engineering</div>
                    <div className="text-gray-500 text-xs">Stanford University</div>
                  </li>
                  <li>
                    <div className="text-teal-600">BSc in Computer Science</div>
                    <div className="text-gray-500 text-xs">Harvard University</div>
                  </li>
                  <li>
                    <div className="text-teal-600">High School Graduation</div>
                    <div className="text-gray-500 text-xs">New York High School</div>
                  </li>
                </ul>
              </div>
            </div>
